...
int main()
{
  ...
  //   std::cout << std::endl;
  // }
  Best3Mutation(positionVector, mutantVector, 10, 0.80, rangeMin, rangeMax, 2, bestPos);
  binomialCrossover(positionVector, mutantVector, trialVector, 0.30, 10);
  for (int j = 0; j < 10; j++)
  {
